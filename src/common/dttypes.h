...
static inline float max3f(const float* pixel)
{
  return fmaxf(fmaxf(pixel[0], pixel[1]), pixel[2]);
}

static inline float min3f(const float* pixel)
{
...
static inline double min3(const double* pixel)
{
  return fmin(fmin(pixel[0], pixel[1]), pixel[2]);
}

static inline double max4(const double* pixel)
{
  return fmax(fmax(fmax(pixel[0], pixel[1]), pixel[2]), pixel[3]);
}

static inline double min4(const double* pixel)
{
  return fmin(fmin(fmin(pixel[0], pixel[1]), pixel[2]), pixel[3]);
}
