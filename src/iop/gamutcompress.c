...
typedef struct dt_iop_gamutcompress_params_t
{
  ...
  dt_iop_gamut_compression_method_t method;         // $DEFAULT: DT_GAMUT_COMPRESSION_METHOD_RGB $DESCRIPTION: "method"
  ...
  float gamut_compression_start_xy_distance_ratio;  // $MIN: 0.0 $MAX: 1.0 $DEFAULT: 0.8 $DESCRIPTION: "xyY compression start"
